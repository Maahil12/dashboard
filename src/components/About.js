      ...
      <section className="about-section" id="about-section">
        ...
        <div className="about-container">
          <div className="about-card">
            <div>
              ...
              <p className="p-color">
                We have the best music system in our bot and many more other features.
              </p>
              <hr />
            </div>
            <div>
            ...
            <div>
              ...
              <p className="p-color">
                Fully usable music discord bot for completely FREE!
              </p>
              <hr />
            </div>
          </div>
        ...
        <section className="about-stats">
          <div className="about-stats-card">
            <h4 className="h-color">67+</h4>
            <p className="p-color">Total Servers</p>
          </div>
          <div className="about-stats-card">
            <h4 className="h-color">3.6k+</h4>
            <p className="p-color">Total Users</p>
          </div>
          <div className="about-stats-card">
            <h4 className="h-color">567+</h4>
